...
**Desenvolvedor Front-end com IA Aplicada e Automação**

[LinkedIn](https://www.linkedin.com/in/fabianofr) · [GitHub](https://github.com/FabianoResende) · [Portfólio](https://fabianoresende.github.io/landing-page-html-css-js/) · [E-mail](mailto:fabianofariaderesende@gmail.com)
...
Atuar como Desenvolvedor Front-end com Inteligência Artificial aplicada, contribuindo em projetos que integrem JavaScript, TypeScript, React, Next.js, APIs e modelos de IA, com foco em qualidade de código, experiência do usuário e automação de processos.
...
*Nov/2016 - Nov/2019 | Niterói, RJ*

Monitoramento diário dos sistemas WA e WPS e suporte técnico de nível 1 aos terminais PERTO TPC 4110. Execução de rotinas de tesouraria, faturamento diário, pagamentos e manuseio de numerário. Elaboração de relatórios em planilhas e organização de documentos administrativos. Análise de ocorrências operacionais e resolução de problemas do dia a dia.
...
- 📍 São Gonçalo - RJ
- ✉️ [E-mail](mailto:fabianofariaderesende@gmail.com)
- 🔗 [LinkedIn](https://www.linkedin.com/in/fabianofr)
- 💻 [GitHub](https://github.com/FabianoResende)
- 🌐 [Portfólio](https://fabianoresende.github.io/landing-page-html-css-js/)
